...
begin<br>
   rgenerator_pkg.generator<br>
          (<br>
            p_in_viewname => 'customers_rest_view'<br>
            ,p_in_metaurl => 'http://myords.myorg.com:8080/ords/prod1/rest_access_api/metadata-catalog/customers_rest_v/'<br>
            ,p_in_metaparams => '?limit=1000'<br>
           );<br>
end;<br>
/<br>
</code>
